    ...
    return (
        <section className="w-full h-auto bg-bodyBg">
            <main className="w-full lg:py-24 md:py-24 py-20 md:px-6 px-3 flex flex-col items-center gap-4">
                <Text as="h2" className="font-bold text-center uppercase lg:text-4xl md:text-3xl text-2xl font-barlow">Select characters to Purchase!</Text>


                <section className=" w-full mt-12 grid lg:grid-cols-2 lg:gap-10 md:gap-20 gap-14">
                    <main className="w-full flex flex-col gap-4">
                        <Text as="h3" className="font-semibold font-belanosima text-2xl tracking-wide text-center">All Characters</Text>
                    ...
                    <main className="w-full flex flex-col items-center gap-4">
                        ...
                        <Text as="p" className="font-semibold font-barlow text-xl tracking-wide text-center">Total Price: {totalCharacterPrice} points</Text>

                        <Button type="button" className=" text-[#0f161b] uppercase font-bold tracking-[1px] text-sm px-[30px] py-3.5 border-[none] bg-[#45f882]  font-barlow hover:bg-[#ffbe18] clip-path-polygon-[100%_0,100%_65%,89%_100%,0_100%,0_0]" onClick={handlePurchaseCharacter}>Purchase Characters</Button>
                    </main>
                </section>
            </main>
        </section>
