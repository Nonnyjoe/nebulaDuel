...
const ContactUsForm = () => {
  ...
  function extractUserDetails(arrayOfData) {
    ...
    console.log(
      "test result is",
      String(arrayOfData[0].walletAddress) === String(connectedAddress)
    );
    ...
    let filteredData = arrayOfData.filter(
      (data) =>
        data.walletAddress.toLowerCase() === connectedAddress.toLowerCase()
    );
        ...
        <div className="container flex">
          <div className="content">
            ...
            <TeamCard
              ...
              title={
                userData ? cutWalletAddress(returnConnectedAddress()) : " "
              }
