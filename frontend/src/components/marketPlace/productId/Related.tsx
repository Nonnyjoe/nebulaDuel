...
const Related = () => {
    ...
    return (
        <section className="w-full flex flex-col mb-20 lg:px-8 md:px-6 px-4">
            <Text as='h3' className="text-gray-200 lg:text-4xl md:text-3xl text-2xl uppercase font-extrabold font-poppins">RELATED PRODUCTS</Text>
                            ...
                            <div className="w-full flex flex-col gap-4">
                                ...
                                <div className="w-full flex flex-col gap-1.5">
                                    <div className="w-full flex justify-between items-center">
                                        ...
                                        <Text as='span' className="text-myGreen font-poppins font-bold">${item.price}</Text>
                                    </div>
