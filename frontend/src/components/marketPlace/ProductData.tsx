import { product1, product2, product3, product4, product5, product6, product7, product8, product9 } from "../../assets/products";
...
export const ListOfProducts: ProductType[] = [
    {
        ...
        isInStock: true,
        img: product1,
        briefDesc: "Lorem ipsum dolor sit amet, consteur adipiscing Duis elementum solliciin is yaugue euismods Nulla ullaorper.",
        model: ["Gat", "Dat4", "Rt30"],
